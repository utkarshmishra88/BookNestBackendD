...
public class WishlistServiceImpl implements WishlistService {
    ...
    @Override
    @Transactional
    public void moveItemToCart(Integer userId, Integer bookId, String token) {
        ...
        req.put("quantity", 1);
        cartClient.addItemToCart(userId, req, token);
