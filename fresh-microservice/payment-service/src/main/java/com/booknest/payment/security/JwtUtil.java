...
/**
 * JWT parsing aligned with order-service and auth-service (JJWT 0.11.x API).
 * Ensures Feign-forwarded Bearer tokens from the gateway are validated consistently.
 */
@Component
